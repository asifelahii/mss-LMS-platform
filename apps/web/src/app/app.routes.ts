...
const lazyAuthGuard: CanActivateFn = (route, state) => {
  ...
  return import('@mss-platform/auth').then((m) =>
...
export const routes: Routes = [
    ...
    children: [
      {
        path: '',
        loadComponent: () =>
          import('./pages/public/public-home/public-home.page').then(
      ...
      },
      {
        path: 'courses',
        loadComponent: () =>
          import('./pages/public/course-catalog/course-catalog.page').then(
      ...
      },
      {
        path: 'courses/:slug',
        loadComponent: () =>
          import('./pages/public/course-detail/course-detail.page').then(
      ...
      },
      {
        path: 'packages',
        loadComponent: () =>
          import('./pages/public/packages/packages.page').then(
      ...
      },
      {
        path: 'enroll',
        loadComponent: () =>
          import('./pages/public/enroll/enroll.page').then(
            (m) => m.EnrollPageComponent,
          ),
        title: 'Enroll | MSS',
      },
      {
  ...
  },
  {
    ...
    canActivate: [
      lazyAuthGuard,
      lazyRoleGuard(['student', 'admin', 'super_admin']),
    ],
    data: {
      portal: 'student',
    },
    children: [
      {
        ...
        loadComponent: () =>
          import(
            './pages/student/student-dashboard/student-dashboard.page'
  ...
  },
  {
    ...
    canActivate: [
      lazyAuthGuard,
      lazyRoleGuard(['teacher', 'admin', 'super_admin']),
    ],
    data: {
      portal: 'teacher',
    },
    children: [
      {
        ...
        loadComponent: () =>
          import(
            './pages/teacher/teacher-dashboard/teacher-dashboard.page'
          ).then((m) => m.TeacherDashboardPageComponent),
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './pages/admin/courses/admin-course-list/admin-course-list.page'
          ).then((m) => m.AdminCourseListPageComponent),
        title: 'Course Management | MSS',
      },
      {
        path: 'courses/new',
        loadComponent: () =>
          import(
            './pages/admin/courses/admin-course-form/admin-course-form.page'
          ).then((m) => m.AdminCourseFormPageComponent),
        title: 'Create Course | MSS',
      },
      {
